...
#-----------------------------------------------------------------------
# Bourne shell environment setup script for Geant4 9.6.4
#
...
# Resource file paths
#
export G4NEUTRONHPDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/G4NDL4.2 > /dev/null ; pwd`"
export G4LEDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/G4EMLOW6.32 > /dev/null ; pwd`"
export G4LEVELGAMMADATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/PhotonEvaporation2.3 > /dev/null ; pwd`"
export G4RADIOACTIVEDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/RadioactiveDecay3.6 > /dev/null ; pwd`"
export G4NEUTRONXSDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/G4NEUTRONXS1.2 > /dev/null ; pwd`"
export G4PIIDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/G4PII1.3 > /dev/null ; pwd`"
export G4REALSURFACEDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/RealSurface1.0 > /dev/null ; pwd`"
export G4SAIDXSDATA="`cd $geant4_envbindir/../share/Geant4-9.6.4/data/G4SAIDDATA1.1 > /dev/null ; pwd`"
